...
{
    return  logging::log(logging::InfoMessage, "PedDetectionGui");
}

std::ostream & log_debug()
{
    return  logging::log(logging::DebugMessage, "PedDetectionGui");
}

std::ostream & log_error()
{
    return  logging::log(logging::ErrorMessage, "PedDetectionGui");
}
...
program_options::options_description PedDetectionGui::get_args_options()
{
    program_options::options_description desc("PedDetectionGui options");
...
PedDetectionGui::PedDetectionGui(PedDetectionApplication &application_,
      ...
      application(application_)
{
    ...
    //{
    //    throw std::runtime_error("PedDetectionGui constructor expects that video_input and stixel_world_estimator_p are already initialized");
    //}
    ...
    // create the application window --
    {
        ...
        {
            throw std::runtime_error("PedDetectionGui constructor expects video_input or directory_input to be already initialized");
        }
    ...
    views_map[SDLK_1] = view_t(boost::bind(&PedDetectionGui::draw_video_input, this), "draw_video_input");
    views_map[SDLK_2] = view_t(boost::bind(&PedDetectionGui::draw_detections, this), "draw_detections");
    views_map[SDLK_3] = view_t(boost::bind(&PedDetectionGui::draw_tracks, this), "draw_tracks");
    views_map[SDLK_4] = view_t(boost::bind(&PedDetectionGui::draw_stixel_world, this), "draw_stixel_world");
    views_map[SDLK_5] = view_t(boost::bind(&PedDetectionGui::draw_ground_plane_estimation, this), "draw_ground_plane_estimation");
    views_map[SDLK_6] = view_t(boost::bind(&PedDetectionGui::draw_stixels_estimation, this), "draw_stixels_estimation");
    views_map[SDLK_7] = view_t(boost::bind(&PedDetectionGui::draw_stixels_height_estimation, this), "draw_stixels_height_estimation");
    views_map[SDLK_8] = view_t(boost::bind(&PedDetectionGui::draw_disparity_map, this), "draw_disparity_map");
    //views_map[SDLK_9] = view_t(boost::bind(&PedDetectionGui::draw_optical_flow, this), "draw_optical_flow");

#if defined(USE_GPU)
    views_map[SDLK_9] = view_t(boost::bind(&PedDetectionGui::draw_gpu_stixel_world, this), "draw_gpu_stixel_world");
#endif
...
PedDetectionGui::~PedDetectionGui()
{
    // nothing to do here
    return;
}
...
void map_to_rectified_image(
        ...
        const PedDetectionGui::detection_t::rectangle_t &box,
        PedDetectionGui::detection_t::rectangle_t &rectified_box)
{
...
void normalized_box_width(PedDetectionGui::detection_t::rectangle_t &box)
{
    const float
...
void map_to_rectified_image(
        ...
        PedDetectionGui::detections_t &rectified_detections)
{
    typedef PedDetectionGui::detection_t detection_t;
...
bool PedDetectionGui::process_inputs()
{
...
void PedDetectionGui::resize_if_necessary()
{
    if(application.video_input_p)
    {
    ...
    {
        throw std::runtime_error("PedDetectionGui::resize_if_necessary could not find an image input");
    }
...
void PedDetectionGui::draw_video_input()
{
...
void PedDetectionGui::draw_detections()
{
...
void PedDetectionGui::draw_tracks()
{
...
void PedDetectionGui::draw_stixel_world()
{
...
#if defined(USE_GPU)
void PedDetectionGui::draw_gpu_stixel_world()
{
    StixelWorldGui::draw_stixel_world();
    ...
    if(gpu_detector_p)
    {
        ...
        for(size_t gpu_stixel_index=0; gpu_stixel_index < cpu_stixels.getNumElements(); gpu_stixel_index +=1)
        {
            ...
            if(min_y > max_y)
            {
                ...
                throw std::runtime_error("PedDetectionGui::draw_gpu_stixel_world says oooups");
            }

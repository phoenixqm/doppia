...
{
    return  logging::log(logging::InfoMessage, "PedDetectionApplication");
}

std::ostream & log_debug()
{
    return  logging::log(logging::DebugMessage, "PedDetectionApplication");
}

std::ostream & log_error()
{
    return  logging::log(logging::ErrorMessage, "PedDetectionApplication");
}
...
std::string PedDetectionApplication::get_application_title()
{
...
PedDetectionApplication::PedDetectionApplication()
    : BaseApplication(),
...
program_options::options_description PedDetectionApplication::get_options_description()
{
...
void PedDetectionApplication::get_all_options_descriptions(program_options::options_description &desc)
{
    desc.add(VideoInputFactory::get_args_options());

    // Objects detection options --
    desc.add(PedDetectionApplication::get_options_description());
    desc.add(PedDetectionGui::get_args_options());
...
void PedDetectionApplication::setup_logging(std::ofstream &log_file, const program_options::variables_map &options)
{
    ...
    if(silent_mode == false)
    {
        ...
        //rules_for_stdout.add_rule(logging::InfoMessage, "PedDetectionApplication");
#if defined(DEBUG)
...
void PedDetectionApplication::setup_problem(const program_options::variables_map &options)
{
...
AbstractGui* PedDetectionApplication::create_gui(const program_options::variables_map &options)
{
    ...
    {
        gui_p = new PedDetectionGui(*this, options);
    }
...
int PedDetectionApplication::get_current_frame_number() const
{
...
void PedDetectionApplication::main_loop()
{
...
void PedDetectionApplication::record_detections()
{
    ...
    if(detections_data_sequence_p == false)
    {
        ...
        attributes.insert(std::make_pair("created_by", "PedDetectionApplication"));
    ...
    BOOST_FOREACH(const detection_t &detection, the_detections)
    {
        ...
        default:
            throw std::invalid_argument(
                        "PedDetectionApplication::record_detections received a detection "
    ...
    return;
} // end of PedDetectionApplication::record_detections
